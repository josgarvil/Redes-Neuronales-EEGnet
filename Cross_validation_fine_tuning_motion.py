...
for i in range(int(length_data/trial_epochs)):
    ...
    x_val=training_motion_data[i*trial_epochs:i*trial_epochs+trial_epochs,:,:]
    ...
    y_val=labels_motion_data_original.transpose()[i*trial_epochs:i*trial_epochs+trial_epochs]
    ...
    # Clone model
    train_model = load_model('checkpoint_motion_pretrained.h5', custom_objects={"recall_metric": recall_metric, "precision_metric": precision_metric, "f1_metric": f1_metric  })
...
savemat('metrics_results_fine_tuning_motion.mat', {'Loss': metric_value[::3], 'Accuracy': metric_value[1::3], 'Accuracy2': acc2, 'F1score': metric_value[2::3]},  oned_as='column')
